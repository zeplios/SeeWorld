...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>SeeWorld视频——天津大学视频中心</title>
		<meta name="keywords" content="" />
		<meta name="description" content="SeeWorld 天津大学视频中心" />
		<link href="<s:property value="basePath"/>styles/layout.css" type="text/css"
			rel="stylesheet" />
		<link href="<s:property value="basePath"/>styles/style.css" type="text/css"
			rel="stylesheet" />		
		<link href="<s:property value="basePath"/>styles/film.css" type="text/css"
			rel="stylesheet" />
		<link href="<s:property value="basePath"/>styles/collect.css" type="text/css"
			rel="stylesheet" />
		<link href="<s:property value="basePath"/>styles/introduce.css" type="text/css"
			rel="stylesheet" />
		<script type="text/javascript"
			src="<s:property value="basePath"/>js/seeworld_multimedia.js"></script>
		<script src="<s:property value="basePath"/>js/introduce.js" type="text/javascript"></script>
		<script src="<s:property value="basePath"/>js/collect.js" type="text/javascript"></script>
		<script src="<s:property value="basePath"/>js/jquery.min.js" type="text/javascript"></script>
		<script type="text/javascript"
...
$(function(){
	...
	<body>
		...
		<div id="popDiv" class="mydiv">
			...
			<form action="" method="post">
				<div class="result_list">
					<div class="V_photo">
						<a href="#"><img alt="" src="images/im15.jpg" /> </a>
					</div>
		...
		<div id="header">
			...
			<div id="content">
				<div class="clear">
					<span>&nbsp;&nbsp;当前位置：<a href="#">SeeWorld</a>&nbsp;&gt;&gt;&nbsp;视频</span>
				</div>
					<!-- left -->
					<div class="film_left">
								...
								<div class="as_category">
									...
									<s:url id="viewAllArea" action="viewByArea"
										...
										<s:iterator value="areaAndCountryList">
											<div class="as_category_content">
													<s:url id="viewVideo" action="viewByArea"
												namespace="/multimedia/Video">
								...
								<div class="as_category">
									...
									<s:url id="viewAllYear" action="viewByYear"
										...
										<s:iterator value="publishedYearList" id="pulishYearList">
											<s:url id="viewVideo" action="viewByYear"
												namespace="/multimedia/Video">
												<s:param name="publishedYear" value="pulishYearList" />
											</s:url>
											<div class="as_category_content">
												<s:a href="%{viewVideo}"><s:property /> </s:a>
											</div>
										</s:iterator>
					...
					<div class="action_right">
						<div class="action_right_block">
							<div class="action_title title_inner">
								...
								<div class="sortSelect">排序方式:
								<s:select id="sort" name="sort" 
										list="#{'更新时间':'2','视频名称':'1','收藏次数':'4','点击次数':'3','推荐次数':'5'}" 
