...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div id="header">
			...
			<div id="content">
			<div class="clear">
					<span>&nbsp;&nbsp;当前位置：<a href="#">SeeWorld</a>&nbsp;&gt;&gt;&nbsp;剧集</span>					
					</div>
								...
								<div class="as_category">
									...
									<div>
										...
										<s:iterator value="areaAndCountryList">
											<div class="as_category_content">
												<s:url id="viewSerial" action="viewByArea"
													namespace="/multimedia/Serial">
								...
								<div class="as_category">
									...
									<div>
										...
										<s:iterator value="publishedYearList" id="pulishYearList">
											<s:url id="viewSerial" action="viewByYear"
												namespace="/multimedia/Serial">
					...
					<s:debug/>
												<s:iterator value="contentList_For_Page"
													...
													<s:url id="playTarget" action="play"
														...
														<!--下一行中 传递id的名称 在SerialVO中是commonID  命名不一致     -->
														<s:param name="id" value="commonId"></s:param>
