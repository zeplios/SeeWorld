...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			var targetId='<s:property value="id"/>';
			var resourceId='<s:property value="resourceId"/>';
			var reply=0;
			$(function(){
				checkCollected({targetUserId:currentUserId, targetId:targetId, resourceId:resourceId});
				findCommentByPage({currentPage:1, targetId:targetId, resourceId:resourceId});
	    	});
		</script>
	</head>
	...
	<body>
		...
		<div class="play_section">
		  <div class="play_title_all">
		    ...
		    <p class="play_info">
		    	<s:a cssClass="play_info_a" href="%{mainpage}">SeeWorld</s:a> &gt; <s:a 
		    			cssClass="play_info_a" href="%{moviepage}">电影</s:a> &gt; <cite class="play_info_time"><s:property value="title"/></cite>
				...
				<span class="play_comment">评论：<em class="play_comment_em"><s:property value="commentsCount"/></em></span>
				<span class="self_collect" style="float:right;"></span>
			</p>
		  </div>
		  ...
		  <div class="play_column_r">
		    <div class="taste">
		      ...
		      <div class="sidebar_list">
		        <ol class="sidebar_ol">
		          <s:iterator value="relativeMovies" id="relativeMovies">
		            ...
		            <li class="sidebar_li_vital">
		              <div class="cover_small_box"><s:a class="v_img_a" href="%{playTarget}">
		              	<img width="112px" height="63px" alt="视频封面" src="<s:property value="basePath" />posters/<s:property value="image"/>"/>
		              </s:a></div>
