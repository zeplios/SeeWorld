...
<html>
	...
	<body>
		<div>
			<form action="/SeeWorld/svc/multimedia/Organization/save.action" method="post">
			组织名称：     <input type="text" name="organization.name"/><br/>
			<!--  英文名：<input type="text"/ name=""><br/>-->
			          地区：     <s:select name="organization.areaAndCountry.id"
						...
						<br/>
			         简介： <input type="text" name="organization.introduction"/><br/>		 
