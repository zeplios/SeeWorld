	...
	<body>
		<div id="containertable">
			...
			<form method="post">
				...
				<div>
					<a class="add"
						href="<%=basePath%>svc/multimedia/Lecturer/preAdd.action">添加新主讲人</a>
				</div>
				<br />
				<div id="quicksearch">
					快速搜索:
				...
				<table cellpadding="0" cellspacing="0" border="0" class="display"
					...
					<tbody id="content_list">
						<s:iterator value="lecturerList" status="st">
							<tr <s:if test="#st.odd">class="tb_bg_odd"</s:if>
								...
								<td>
									<s:property value="videos" />
								</td>
								<td>
								<a
										href="/SeeWorld/svc/multimedia/Lecturer/preUpdate.action?targetId=<s:property value="id" />">编辑
								</a>
								</td>
								<td>
									<a class="add"
										href="<%=basePath%>svc/multimedia/Lecturer/delete.action?targetId=<s:property value="id" />"><img
