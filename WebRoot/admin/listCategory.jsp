	...
	<body>
		<div id="containertable">
			...
			<form method="post">
				...
				<div>
					<a class="add"
						href="<%=basePath%>svc/multimedia/Category/preAdd.action">添加新类别</a>
				</div>
				<br />
				<div id="quicksearch">
					快速搜索:
					...
					<tbody id="content_list">
						<s:iterator value="categoryList" status="st">
							<tr <s:if test="#st.odd">class="tb_bg_odd"</s:if>
								...
								<td>
									<a
										href="/SeeWorld/svc/multimedia/Category/preUpdate.action?targetId=<s:property value="id" />">编辑
									</a>
								</td>
								<td>
									<a class="add"
										href="<%=basePath%>svc/multimedia/Category/delete.action?targetId=<s:property value="id" />"><img
