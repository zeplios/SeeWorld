	...
	<body>
		<div id="containertable">
			...
			<form method="post">
                <div>
					<a class="add"
						href="<%=basePath%>svc/multimedia/AreaAndCountry/preAdd.action">添加新地区和国家</a>
				</div>
				<br />
				<div id="quicksearch">
					快速搜索:
				...
				<table cellpadding="0" cellspacing="0" border="0" class="display"
					...
					<tbody id="content_list">
						<s:iterator value="areaAndCountryList" status="st">
							<tr <s:if test="#st.odd">class="tb_bg_odd"</s:if>
								...
								<td>
								        <a
										href="/SeeWorld/svc/multimedia/AreaAndCountry/preUpdate.action?targetId=<s:property value="id" />">编辑
										</a>
								</td>
								<td>
									<a class="add"
										href="<%=basePath%>svc/multimedia/AreaAndCountry/delete.action?targetId=<s:property value="id" />"><img
