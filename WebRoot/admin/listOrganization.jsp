	...
	<body>
		<div id="containertable">
			...
			<form method="post">
                ...
                <div>
					<a class="add" href="<%=basePath%>svc/multimedia/Organization/preAdd.action">添加新组织</a>
				</div>
				<br/>
				<div id="quicksearch">
					快速搜索:
				...
				<table cellpadding="0" cellspacing="0" border="0" class="display"
					...
					<tbody id="content_list">
						<s:iterator value="organizationList" status="st">
							<tr <s:if test="#st.odd">class="tb_bg_odd"</s:if>
								...
								<td>
							            <a
										href="/SeeWorld/svc/multimedia/Organization/preUpdate.action?targetId=<s:property value="id" />">编辑
										</a>
								</td>
								<td>
									<a class="add"
										href="<%=basePath%>svc/multimedia/Organization/delete.action?targetId=<s:property value="id" />"><img
											src="<%=basePath%>/admin/images/icons/cross_circle.png" />
									</a>
								</td>
							</tr>
						</s:iterator>
